...
printf "\n*****\nOpenNIC\n*****\n"
fdns --list=OpenNIC --zone=Europe | grep "servers found"  | awk '{print "Europe " $1}'
fdns --list=OpenNIC --zone=Asia-Pacific | grep "servers found"  | awk '{print "Asia-Pacific " $1}'
fdns --list=OpenNIC --zone=Americas-East | grep "servers found"  | awk '{print "Americas-East " $1}'
fdns --list=OpenNIC --zone=Americas-West | grep "servers found"  | awk '{print "Americas-West " $1}'
...
printf "\n*****\nanycast\n*****\n"
fdns --list=anycast --zone=Europe | grep "servers found"  | awk '{print "Europe " $1}'
fdns --list=anycast --zone=Asia-Pacific | grep "servers found"  | awk '{print "Asia-Pacific " $1}'
fdns --list=anycast --zone=Americas-East | grep "servers found"  | awk '{print "Americas-East " $1}'
fdns --list=anycast --zone=Americas-West | grep "servers found"  | awk '{print "Americas-West " $1}'
